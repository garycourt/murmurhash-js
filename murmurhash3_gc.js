...
function murmurhash3_128_raw_gc(key, seed) {
	...
	while (i < blocks) {
		...
		k2 = (k2 << 16) | (k2 >>> 16);
		k2 = (((k2 & 0xffff) * c3) + ((((k2 >>> 16) * c3) & 0xffff) << 16)) & 0xffffffff;
		h2 ^= k2;

        h2 = (h2 << 17) | (h2 >>> 15);
        h2 = ((h2 & 0xffff) + (h3 & 0xffff)) + ((((h2 >>> 16) + (h3 >>> 16)) & 0xffff) << 16);
		h2b = (((h2 & 0xffff) * 5) + ((((h2 >>> 16) * 5) & 0xffff) << 16)) & 0xffffffff;
		h2 = (((h2b & 0xffff) + 0xa747) + ((((h2b >>> 16) + 0x0bca) & 0xffff) << 16));

        k3 = (((k3 & 0xffff) * c3) + ((((k3 >>> 16) * c3) & 0xffff) << 16)) & 0xffffffff;
		k3 = (k3 << 17) | (k3 >>> 15);
		k3 = (((k3 & 0xffff) * c4) + ((((k3 >>> 16) * c4) & 0xffff) << 16)) & 0xffffffff;
		h3 ^= k3;

        h3 = (h3 << 15) | (h3 >>> 17);
        h3 = ((h3 & 0xffff) + (h4 & 0xffff)) + ((((h3 >>> 16) + (h4 >>> 16)) & 0xffff) << 16);
		h3b = (((h3 & 0xffff) * 5) + ((((h3 >>> 16) * 5) & 0xffff) << 16)) & 0xffffffff;
		h3 = (((h3b & 0xffff) + 0x1c35) + ((((h3b >>> 16) + 0x96cd) & 0xffff) << 16));

        k4 = (((k4 & 0xffff) * c4) + ((((k4 >>> 16) * c4) & 0xffff) << 16)) & 0xffffffff;
		k4 = (k4 << 18) | (k4 >>> 14);
		k4 = (((k4 & 0xffff) * c1) + ((((k4 >>> 16) * c1) & 0xffff) << 16)) & 0xffffffff;
		h4 ^= k4;

        h4 = (h4 << 13) | (h4 >>> 19);
        h4 = ((h4 & 0xffff) + (h1 & 0xffff)) + ((((h4 >>> 16) + (h1 >>> 16)) & 0xffff) << 16);
		h4b = (((h4 & 0xffff) * 5) + ((((h4 >>> 16) * 5) & 0xffff) << 16)) & 0xffffffff;
	...
	h2 ^= h2 >>> 16;
	h2 = (((h2 & 0xffff) * 0x85ebca6b) + ((((h2 >>> 16) * 0x85ebca6b) & 0xffff) << 16)) & 0xffffffff;
	h2 ^= h2 >>> 13;
	h2 = (((h2 & 0xffff) * 0xc2b2ae35) + ((((h2 >>> 16) * 0xc2b2ae35) & 0xffff) << 16)) & 0xffffffff;
	h2 ^= h2 >>> 16;

	h3 ^= h3 >>> 16;
	h3 = (((h3 & 0xffff) * 0x85ebca6b) + ((((h3 >>> 16) * 0x85ebca6b) & 0xffff) << 16)) & 0xffffffff;
	h3 ^= h3 >>> 13;
	h3 = (((h3 & 0xffff) * 0xc2b2ae35) + ((((h3 >>> 16) * 0xc2b2ae35) & 0xffff) << 16)) & 0xffffffff;
	h3 ^= h3 >>> 16;

	h4 ^= h4 >>> 16;
	h4 = (((h4 & 0xffff) * 0x85ebca6b) + ((((h4 >>> 16) * 0x85ebca6b) & 0xffff) << 16)) & 0xffffffff;
	h4 ^= h4 >>> 13;
	h4 = (((h4 & 0xffff) * 0xc2b2ae35) + ((((h4 >>> 16) * 0xc2b2ae35) & 0xffff) << 16)) & 0xffffffff;
	h4 ^= h4 >>> 16;
